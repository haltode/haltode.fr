...
\begin{tikzpicture}[list/.style={fill=blue!20, font=\sffamily\Large\bfseries, rectangle split, rectangle split parts=2,
...
\vspace{3cm}
\begin{tikzpicture}[list/.style={fill=blue!20, font=\sffamily\Large\bfseries, rectangle split, rectangle split parts=3,
    draw, rectangle split horizontal}, >=stealth, start chain]
  \node[list,on chain] (A) {\nodepart{second}42};
  \node[list,on chain] (B) {\nodepart{second}-7};
  \node[list,on chain] (C) {\nodepart{second}9};

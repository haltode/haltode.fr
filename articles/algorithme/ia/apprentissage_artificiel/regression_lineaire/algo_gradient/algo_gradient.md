...
Dans le cadre d'une [régression linéaire](/algo/ia/apprentissage_artificiel/regression_lineaire.html), on cherche à définir une fonction d'hypothèse proche de la réalité et de la forme :
...
![Représentation graphique de la fonction d'erreur](//static.napnac.ga/img/algo/ia/apprentissage_artificiel/regression_lineaire/exemple_fonction_erreur.png)
...
![Echelles différentes au sein des attributs](//static.napnac.ga/img/algo/ia/apprentissage_artificiel/regression_lineaire/algo_gradient/echelles_differentes.png)
...
![Echelles similaires](//static.napnac.ga/img/algo/ia/apprentissage_artificiel/regression_lineaire/algo_gradient/echelles_similaires.png)
...
![Sortie graphique après opération de feature scaling](//static.napnac.ga/img/algo/ia/apprentissage_artificiel/regression_lineaire/algo_gradient/sortie_prog_feature_scaling.png)

...
\draw[very thick] (0.25,-2.75) circle (0.1);
\draw[very thick] (0.75,-2.75) circle (0.1);
\draw[thick, blue] (-0.65,-1.25) -- (-0.35,-1.25);
\draw[thick, blue] (-0.15,-1.25) -- (0.15,-1.25);
\draw[thick, blue] (-0.65,-1.75) -- (-0.35,-1.75);
\draw[thick, blue] (-0.15,-1.75) -- (0.15,-1.75);
\draw[thick, blue] (-0.15,-2.25) -- (0.15,-2.25);
\draw[thick, blue] (-0.15,-2.75) -- (0.15,-2.75);
\draw[thick, blue] (0.35,-2.75) -- (0.65,-2.75);
\draw[thick, blue] (-0.75,-1.85) -- (-0.75,-2.15);
\draw[thick, blue] (-0.75,-2.35) -- (-0.75,-2.65);
\draw[thick, blue] (-0.25,-2.35) -- (-0.25,-2.65);
\draw[thick, blue] (0.25,-1.35) -- (0.25,-1.65);
\draw[thick, blue] (0.25,-1.85) -- (0.25,-2.15);
\draw[thick, blue] (0.75,-1.35) -- (0.75,-1.65);
\draw[thick, blue] (0.75,-1.85) -- (0.75,-2.15);
\draw[thick, blue] (0.75,-2.35) -- (0.75,-2.65);
\end{tikzpicture}

...
Le fait que la substitution soit mono-alphabétique signifie que si l’on chiffre plusieurs fois la lettre A avec une clé de chiffrement *x*, alors la lettre chiffrée sera toujours la même, ce type de système s’oppose donc à la **substitution poly-alphabétique** utilisée par le [chiffre de Vigenère](/pages/algo/chiffrement/chiffre_vigenere.html) par exemple.
